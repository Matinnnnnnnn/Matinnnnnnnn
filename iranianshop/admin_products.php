...
if (isset($_GET['action']) && $_GET['action'] == 'EDIT') {
    $id = $_GET['id'];
    $query = "SELECT * FROM produts WHERE pro_code='$id'";
...
<tr>
	...
	<td>
     <b><a href="action_admin_products.php?id=<?php echo ($row['pro_code']) ?>&action=DELETE" style="text-decoration: none; font-family: B titr">حذف</a></b>    
     &nbsp;|&nbsp;
     <b><a href="admin_products.php?id=<?php echo ($row['pro_code']) ?>&action=EDIT" style="text-decoration: none;font-family: B titr">ويرايش</a></b>    
    </td>
</tr>
<?php
} //while
