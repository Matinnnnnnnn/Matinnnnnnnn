...
if (mysqli_query($link, $query) === true) {
    ...
    echo ("<p style='color:brown;'><br/><b>محصول $pro_name با کد $pro_code به تعداد/مقدار $pro_qty با قیمت پایه $pro_price تومان را سفارش داده‌اید</b></p>");
    echo ("<p style='color:red;'><br/><b>مبلغ قابل پرداخت برای سفارش ثبت شده $total_price تومان است</b></p>");
    ...
    $query = "UPDATE produts SET pro_qty=pro_qty-$pro_qty WHERE pro_code='$pro_code'";
