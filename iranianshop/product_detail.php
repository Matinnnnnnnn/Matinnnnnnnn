    ...
    <tr>
        ...
        if ($row = mysqli_fetch_array($result)) {
            ...
            <td style="border-style: dotted dashed;vertical-align: top;">
                ...
                <img src="images/products/<?php echo ($row['pro_image']) ?>" width="350px" height="250px" />
                ...
                <br /><br />
                <b><a href="order.php?id=<?php echo ($row['pro_code']) ?>" style="text-decoration: none;">سفارش و خرید
                        پستی</a></b>
                <br /><br />
