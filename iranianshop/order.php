...
<a href='login.php' style='text-decoration: none;' ><span><b style="color:green;">اینجا</b></span></a>
کلیک کنید
<br/>

 و در صورتی که عضو نیستید برای ثبت نام در سایت
<a href='register.php' style='text-decoration: none;' ><span><b style='color:yellow;'>اینجا</b></span></a>
کلیک کنید
<br /><br />
<?php
...
$query = "SELECT * FROM produts WHERE pro_code='$pro_code'";
...
?> 
  ...
  <br />
    ...
    <tr>
       ...
       <td><input type="text" style="text-align: left;background-color: lightgray;" id="pro_price" name="pro_price" value="<?php echo ($row['pro_price']); ?>"  readonly  />تومان</td>
    </tr>
 
 
    <tr>
       <td>مبلغ قابل پرداخت<span style="color: red;">*</span></td>
       <td><input type="text" style="text-align: left;background-color: lightgray;" id="total_price" name="total_price" value="0"  readonly  />تومان</td>
    </tr>
